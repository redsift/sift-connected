 ...
 */
var ConnectedEmailClientController = (function (EmailClientController) {
  function ConnectedEmailClientController() {
    EmailClientController.call(this);
  }

  if ( EmailClientController ) ConnectedEmailClientController.__proto__ = EmailClientController;
  ConnectedEmailClientController.prototype = Object.create( EmailClientController && EmailClientController.prototype );
  ConnectedEmailClientController.prototype.constructor = ConnectedEmailClientController;

  // TODO: link to docs
  ConnectedEmailClientController.prototype.loadThreadListView = function loadThreadListView (listInfo) {
    var url = '';
  ...
  return ConnectedEmailClientController;
